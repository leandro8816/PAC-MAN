...
import static pt.isec.pa.tinypac.model.fsm.PacManStates.START;
...
public class StartsUI extends AnchorPane {
    GameManager gameManager;
    TilePane tilePane;
    Button btnEnd;

    public StartsUI(GameManager gameManager) {
    ...
    private void update() {
        if (gameManager.getFsm().getCurrentState() != START) {
